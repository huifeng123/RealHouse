...
vrDescription = "RMPANO HTML5版本正式发布！支持safari和chrome浏览器，支持iPhone、iPad、iPod设备。支持立方体的六张图和条形图，支持预览，支持自定义控制面板，支持背景音乐。<br>";

/*
全景图地址，预览图使用横向或纵向条形图，全景图支持两种模式：立方体6张图，立方体条形图；
*/
preview = "staticfile/images/2/preview.jpg";
/*6张图*/
panoType = "cube";
cube_f = "staticfile/images/2/f.jpg";
cube_r = "staticfile/images/2/r.jpg";
cube_b = "staticfile/images/2/b.jpg";
cube_l = "staticfile/images/2/l.jpg";
cube_u = "staticfile/images/2/u.jpg";
cube_d = "staticfile/images/2/d.jpg";
/*条形图*/
//panoType = "cubestrip";
//cubestrip = "pano0.jpg";
