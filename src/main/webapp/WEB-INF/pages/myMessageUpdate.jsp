...
<div class="contact">
	<div class="container">
		<h3>个人信息</h3>
<center>
	<form class="form-horizontal" enctype="multipart/form-data" role="form" method="post" action="/updateUser">
...
<table<%-- id="ec_table"--%> class="table table-hover table-bordered" width="400" align="CENTER">
	...
	<tr class="warning" align="center">
		...
		<td width="50%"><%--<input type="text"  name="uname" value="--%>${user.uname}<%--" readonly="readonly"/>--%></td>
	</tr>
	<tr class="warning" align="center">
		<td width="50%">真&nbsp;&nbsp;实&nbsp;&nbsp;姓&nbsp;&nbsp;名</td>
		<td width="50%"><input type="text"  name="urname" value="${user.urname}"/></td>
	</tr>
	<tr class="warning" align="center">
		<td width="50%">昵&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;称</td>
		<td width="50%"><input type="text"  name="uuser" value="${user.uuser}"/></td>
	</tr>
	<tr class="warning" align="center">
		<td width="50%">性&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别</td>
		<td width="50%"><input type="text"  name="sex" value="${user.sex}"/></td>
	</tr>
	<tr class="warning" align="center">
		<td width="50%">邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱</td>
		<td width="50%"><input type="text"  name="uemail" value="${user.uemail}"/></td>
	</tr>
	<tr class="warning" align="center">
		<td width="50%">电&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;话</td>
		<td width="50%"><input type="text"  name="tel" value="${user.tel}"/></td>
	</tr>
	<tr class="warning" align="center">
		<td width="50%">邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;编</td>
		<td width="50%"><input type="text"  name="post" value="${user.post}"/></td>
	</tr>
	<tr class="warning" align="center">
		<td width="50%">地&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;址</td>
		<td width="50%"><input type="text"  name="uaddress" value="${user.uaddress}"/></td>
	</tr>
	<tr class="warning" align="center">
		<td width="50%">QQ</td>
		<td width="50%"><input type="text"  name="qq" value="${user.qq}"/></td>
	</tr>
	<tr class="warning" align="center">
		<td width="50%" >
		...
		<td width="50%" >
			<a class="btn btn-info" href="#" onclick="formSubmit('/toshowMyMessage','_self');this.blur();">返回</a>
			<%--<form class="form-horizontal" enctype="multipart/form-data" role="form" method="post" action="/pages/updateUser">
				<input type="text" name="uid" value="${session_user.uid}" hidden="hidden"/>
