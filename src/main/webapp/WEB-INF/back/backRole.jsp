  ...
  <div class="right-product view-product right-full">
     <div class="container-fluid">
				...
				<div class="message-manage info-center">
					...
					<div >
						<form method="post">
                            <input class="btn btn-primary" type="submit" value="查看所有" formaction="${ctx}/back/backRole"/>
                            <input class="btn btn-primary" type="submit" value="查看房东" formaction="${ctx}/back/roleOne"/>
                            <input class="btn btn-primary" type="submit" value="查看租客" formaction="${ctx}/back/roleZero">
