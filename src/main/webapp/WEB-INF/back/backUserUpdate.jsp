  ...
  <div class="right-product view-product right-full">
     <div class="container-fluid">
				<div class="manage account-manage info-center">
					...
					<div>
                      <form method="post">
                          <input class="btn btn-primary" type="submit" value="确认修改" formaction="${ctx}/back/userUpdate" >
                        ...
                        <table id="ec_table" class="table" width="50%" >
                            ...
                            <tr class="odd">
                                ...
                                <td> <input type="text" name="urname" value="${user.urname}"></td>
                            </tr>
                            <tr class="odd">
                            ...
                            <tr class="odd">
                                ...
                                <td> <input type="text" name="uuser" value="${user.uuser}"></td>
                            </tr>
                            <tr class="odd">
                            ...
                            <tr class="odd">
                                ...
                                <td> <input type="text" name="post" value="${user.post}"></td>
                            </tr>
                            <tr class="odd">
