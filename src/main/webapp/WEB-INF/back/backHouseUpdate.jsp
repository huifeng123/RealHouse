				...
				<div class="manage account-manage info-center">
                    ...
                    <div align="right">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li id="update"><a class="btn btn-success" href="#" onclick="formSubmit('update','_self');this.blur();">修改</a></li>
                    ...
                    <form class="form-horizontal" role="form">
                        ...
                        <div>
                            ...
                            <div class="eXtremeTable" >
                                <table id="ec_table" class="table table-bordered" width="98%" >
                                    ...
                                    <tr class="warning">
                                        ...
                                        <td><input type="text" name="userInfo.uuser" value="${user.userInfo.name}"/></td>
                                    ...
                                    <tr class="warning">
                                        ...
                                        <td><select name="house.hcountry" style="width:120px">
                                            <option>---请选择---</option>
                                    ...
                                    <tr class="warning">
                                        ...
                                        <td><select name="house.hstructure" style="width:120px">
                                            <option>---请选择---</option>
                                    ...
                                    <tr class="warning">
                                        ...
                                        <td><select name="house.face" style="width:120px">
                                            <option>---请选择---</option>
                                    ...
                                    <tr class="warning">
                                        ...
                                        <td>
                                            <input type="radio" name="houseInfo.hasbed" value="1" checked="checked"/>有
                                            <input type="radio" name="houseInfo.hasbed" value="0"/>无
                                        </td>
                                        <td class="tableHeader">电视</td>
                                        <td>
                                            <input type="radio" name="houseInfo.hastv" value="1" checked="checked"/>有
                                    ...
                                    <tr class="warning">
                                        ...
                                        <td>
                                            <input type="radio" name="houseInfo.hasfridge" value="1" checked="checked"/>有
                                            <input type="radio" name="houseInfo.hasfridge" value="0"/>无
                                        </td>
                                        <td class="tableHeader">洗衣机</td>
                                        <td>
                                            <input type="radio" name="houseInfo.haswasher" value="1" checked="checked"/>有
                                    ...
                                    <tr class="warning">
                                        ...
                                        <td>
                                            <input type="radio" name="houseInfo.haskt" value="1" checked="checked"/>有
                                            <input type="radio" name="houseInfo.haskt" value="0"/>无
                                        </td>
                                        <td class="tableHeader">暖气</td>
                                        <td>
                                            <input type="radio" name="houseInfo.hasnq" value="1" checked="checked"/>有
                                    ...
                                    <tr class="warning">
                                        ...
                                        <td>
                                            <input type="radio" name="houseInfo.hasfurniture" value="1" checked="checked"/>有
                                    ...
                                    <tr class="warning">
                                        ...
                                        <td>
                                            <input type="radio" name="houseInfo.hasgas" value="1" checked="checked"/>有
                                            <input type="radio" name="houseInfo.hasgas" value="0"/>无
                                        </td>
                                        <td class="tableHeader">热水器</td>
                                        <td>
                                            <input type="radio" name="houseInfo.hasrsq" value="1" checked="checked"/>有
